...
#
file_name = './results/sample.mpm.L2.month='+str(idd)+'.mat'
load_data = sio.loadmat(file_name)
...
for idd in range(1,uff_dim+1) :
    print ( 'Loading... ', idd )
    file_name = './results/estimates.mpm.L2.month='+str(idd)+'.mat'
    load_data = sio.loadmat(file_name)
    beta_mat[:,idd-1] = load_data['beta_est_mpm_L2'].flatten() ;
    sig2_mat[:,idd-1] = load_data['sig2_est_mpm_L2'].flatten() ;
#
file_name = './results/sample.inv.mpm.L2.month=all.mat'
load_data = sio.loadmat(file_name)
...
#
file_name = './results/sample.valid.mpm.L2.month=all.mat'
