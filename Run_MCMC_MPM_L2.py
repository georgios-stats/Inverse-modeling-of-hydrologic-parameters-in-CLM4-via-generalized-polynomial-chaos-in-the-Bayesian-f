...
load_data = sio.loadmat(file_name)
ga_seed = 1*(load_data['Pr_aux_est_bma_L2']>0.5)  ; ga_seed = ga_seed.flatten()
#
...
# save chain
#
file_name = './results/sample.mpm.L2.month='+str(id)+'.mat'
sio.savemat( file_name, \
				{ \
				'n_chain':Nsweep, \
				'dmax':dmax, \
				'pr_ga_chain_mpm_L2':pr_ga_chain, \
				'ga_chain_mpm_L2':ga_chain, \
				'ga_chain_mpm_L2':ga_chain, \
				'beta_chain_mpm_L2':beta_chain, \
				'rho_chain_mpm_L2':rho_chain, \
				'sig2_chain_mpm_L2':sig2_chain, \
				'lam_chain_mpm_L2':lam_chain \
				} \
			)
#
# save estimates
#
Pr_ga_mpm = mean( pr_ga_chain[1:Nsweep,:], 0 )
Pr_mpm = mean( ga_chain[1:Nsweep,:], 0 )
beta_mpm = mean( beta_chain[1:Nsweep,:], 0 )
rho_mpm = mean( rho_chain[1:Nsweep] )
sig2_mpm = mean( sig2_chain[1:Nsweep] )
lam_mpm = mean( lam_chain[1:Nsweep] )
#
Pr_ga_mpm_median = median( pr_ga_chain[1:Nsweep,:], 0 )
beta_mpm_median = median( beta_chain[1:Nsweep,:], 0 )
rho_mpm_median = median( rho_chain[1:Nsweep] )
sig2_mpm_median = median( sig2_chain[1:Nsweep] )
lam_mpm_median = median( lam_chain[1:Nsweep] )
#
file_name = './results/estimates.mpm.L2.month='+str(id)+'.mat'
sio.savemat( file_name, \
				{ \
				'Pr_aux_est_mpm_L2':Pr_ga_mpm, \
				'Pr_est_mpm_L2':Pr_mpm, \
				'beta_est_mpm_L2':beta_mpm, \
				'rho_est_mpm_L2':rho_mpm, \
				'sig2_est_mpm_L2':sig2_mpm, \
				'lam_est_mpm_L2':lam_mpm, \
				'Pr_aux_est_mpm_median_L2':Pr_ga_mpm_median, \
				'beta_est_mpm_median_L2':beta_mpm_median, \
				'rho_est_mpm_median_L2':rho_mpm_median, \
				'sig2_est_mpm_median_L2':sig2_mpm_median, \
				'lam_est_mpm_median_L2':lam_mpm_median, \
				'beta_seed_mpm_L2':beta_seed, \
				'sig2_seed_mpm_L2':sig2_seed \
				} \
			)
#
print(' ***END*** ')
